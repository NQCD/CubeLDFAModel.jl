...
model = LDFAModel(Free(), atoms, cell, :cube; cube_filename="test.cube", friction_atoms=[1, 2])
...
model = LDFAModel(Free(), atoms, cell, :scikit; friction_atoms=[55, 56], descriptors=desc, loaded_model=model_ml)
